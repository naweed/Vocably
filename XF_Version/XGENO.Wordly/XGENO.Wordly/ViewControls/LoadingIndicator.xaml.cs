...
namespace XGENO.Wordly.ViewControls
{
    public partial class LoadingIndicator : Frame
    {
        ...
        private static void SetLoadingText(BindableObject bindable, object oldValue, object newValue) => (bindable as LoadingIndicator).lblLoadingText.Text = (string)newValue;
